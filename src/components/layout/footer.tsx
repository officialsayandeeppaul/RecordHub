        ...
        <div className="grid grid-cols-2 gap-8 md:grid-cols-4 lg:gap-12">
          ...
          <div className="space-y-5">
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li><Link href="/records" className="text-muted-foreground hover:text-foreground transition-colors">Records</Link></li>
          ...
          <div className="space-y-5">
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li><Link href="/api-docs" className="text-muted-foreground hover:text-foreground transition-colors">API Reference</Link></li>
          ...
          <div className="flex flex-col items-center justify-between gap-6 md:flex-row">
            <div className="text-center md:text-left">
              <p className="text-sm text-muted-foreground">
                Built with ❤️ by{" "}
                <span className="font-semibold text-foreground">Sayandeep Paul</span>
              </p>
